...
if (isset($_GET['entity']) && isset($_GET['action']) && isset($_GET['id'])) {
    ...
    if ($action == "delete") {
        ...
        if($entity=="post"){
            $query = $db->prepare("UPDATE posts SET status='1' WHERE id = :id");
            $query->execute(['id' => $id]);
        }
...
$query_posts = "SELECT * FROM posts  WHERE status='0' ORDER BY id DESC";
                        ...
                        if ($posts->rowCount() > 0) {
                            foreach ($posts as $post) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?entity=post&action=update&id=<?php echo $post['id'] ?>" class="btn btn-outline-success">Approve</a>
                        ...
                        if ($comments->rowCount() > 0) {
                            foreach ($comments as $comment) {
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="index.php?entity=comment&action=approve&id=<?php echo $comment['id'] ?>" class="btn btn-outline-success">Approve</a>
