        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <form method="post" class="mb-5" enctype="multipart/form-data">
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">title of journal.</small>
                </div>
                <div class="form-group">
                    <label for="author">Author : </label>
                    <input type="text" class="form-control" value="<?php echo $post['author'] ?>" name="author" id="author">
                    <small class="form-text text-muted">name of author.</small>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <small class="form-text text-muted">body text.</small>
                </div>
                ...
                <button type="submit" name="edit_post" class="btn btn-outline-primary">Edit</button>
            </form>
